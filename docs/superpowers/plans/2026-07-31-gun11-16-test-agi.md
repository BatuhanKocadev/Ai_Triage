...
| `tests/yardimcilar/veri_uretici.py` | `kullanici_olustur`, `ziyaret_olustur` yardımcıları |
...
## Görev 1: pytest çatısı ve ilk kırmızı
...
## Görev 2: Veritabanı ve istemci fixture'ları
...
## Görev 3: Sahte servisler ve veri üretici
...
## Görev 4: Auth katmanı testleri  ·  Subagent 1
...
## Görev 5: RAG eşik kapısı testleri  ·  Subagent 2
...
## Görev 6: Triyaj normalizasyon testleri  ·  Subagent 3
...
## Görev 7: /ai/analiz sözleşme testleri  ·  Subagent 4
...
## Görev 8: Ses zinciri testleri  ·  Subagent 5
...
## Görev 9: Bütün paket doğrulaması ve kapanış
