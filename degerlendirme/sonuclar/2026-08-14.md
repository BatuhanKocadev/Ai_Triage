...
| Tetkik Jaccard (ort.) | 0.26 (8 senaryodan) |
...
| kor_04 | Yeşil | Sarı | evet | B | Göğüs Radyografisi | Kontrol kamerografisi, Pulmonoloji referansı | 0.00 |
...
| kor_08 | Yeşil | Kırmızı | evet | B | Tam kan sayımı, Rutin biyokimya | Tam kan sayımı, Bilgisayar destekli imgeleme (CİT), Sıcaklık ölçümü | 0.25 |
...
| tur_06 | Kırmızı | Kırmızı | evet | C | Tam kan sayımı | FAST-ED skoru belirleme, Nörolojik değerlendirme (Glasgow Koma Skalası), Fokal serebral fonksiyon kaybı belirtileri sorgulama | 0.00 |
| tur_07 | Sarı | Kırmızı | HAYIR | A | Parmak ucu kan şekeri, Rutin laboratuvar testleri, Serum elektrolitleri | Basılansal kan testi, Cerebelomielografya (CT), Neuroloji değerlendirme | 0.00 |
...
| tur_13 | Kırmızı | Kırmızı | evet | C | Klinik değerlendirme ve fizik muayene | Tam kan sayımı, Plasma kloroteli testi, Bilirrital kontrol | 0.00 |
...
| tur_19 | Sarı | Sarı | evet | C | Parmak ucu kan şekeri, Tam kan sayımı, Rutin biyokimya | Kontrol kan sayımı, Biyokimyasal kontrol (sakaroz, kreatinin vb.) | 0.00 |
