...
| Tetkik Jaccard (ort.) | 0.22 (8 senaryodan) |
...
| kor_04 | Yeşil | Sarı | evet | B | Göğüs Radyografisi | Batın muayenesi, X-ışığı batın röntgeni | 0.00 |
| kor_05 | Sarı | Kırmızı | evet | B | — | Tam kan sayımı, Cilt biyopsisi | 0.00 |
| kor_06 | Sarı | Sarı | evet | C | Klinik değerlendirme ve fizik muayene, Tam kan sayımı | Genel kan sayımı, Cilt biyopsisi | 0.00 |
| kor_07 | Sarı | Sarı | evet | C | Tam kan sayımı, Biyokimya, Tam İdrar Tetkiki | Hemogram (Tam kan sayımı), Biyokimya, Tam İdrar Tetkiki (TİT), Beta-hCG | 0.75 |
| kor_08 | Yeşil | Kırmızı | evet | B | Tam kan sayımı, Rutin biyokimya | Tam kan sayımı, Bilgisayar destekli görüntüleme (CT), Üst solunum yolu örneklemesi | 0.25 |
...
| Eşik altı oranı | %0.0 (0) |
| Tetkik Jaccard (ort.) | 0.28 (19 senaryodan) |
| Kök neden A/B/C | 2 / 2 / 15 |
| Şanslı doğru | 0 |
| Ölçülemedi (altyapı) | 0 |
| Sonucu yazılmamış | 0 |
...
| tur_02 | Sarı | Sarı | evet | C | EKG, Tam kan sayımı, Rutin biyokimya, Direkt grafi | Elektrokardiyografi (EKG), Kontrol EKG (10 dakika sonra), Tam kan sayımı, Nefes ve solunum testleri | 0.33 |
| tur_03 | Sarı | Sarı | evet | C | Göğüs Radyografisi, Kan Gazı Analizi | Elektrokardiyografi (EKG), SpO2 ölçümü, Tam kan sayımı | 0.00 |
| tur_04 | Sarı | Kırmızı | evet | B | Tam kan sayımı, Biyokimya, Tam İdrar Tetkiki, EKG | Hemogram (Tam kan sayımı), Biyokimya, Tam İdrar Tetkiki (TİT), Beta-hCG | 0.60 |
| tur_05 | Kırmızı | Kırmızı | evet | C | Nörolojik değerlendirme, Bilgisayarlı Tomografi, Tam kan sayımı, Rutin biyokimya | Tam kan sayımı, Kanamaya yönelik laboratuvar testleri, Nörolojik muayene | 0.17 |
| tur_06 | Kırmızı | Kırmızı | evet | C | Tam kan sayımı | FAST-ED skoru belirlenmesi, Nörolojik değerlendirme (Glasgow Koma Skalası), Fokal serebral fonksiyon kaybı belirtileri sorgulanması | 0.00 |
| tur_07 | Sarı | Kırmızı | HAYIR | A | Parmak ucu kan şekeri, Rutin laboratuvar testleri, Serum elektrolitleri | Basılansal kan testi, Koordinasyon testleri, EKG | 0.00 |
| tur_08 | Kırmızı | Kırmızı | evet | C | e-FAST, Tam kan sayımı, Laktat, Bilgisayarlı Tomografi | e-FAST, Tam Kan Sayımı, Laktat | 0.75 |
| tur_09 | Kırmızı | Kırmızı | evet | C | Karboksihemoglobin, Kan gazı | Tam kan sayımı, Bakteriyoloji bakteriyenizotu, Ses ve ses organları kontrolü | 0.00 |
| tur_10 | Yeşil | Yeşil | evet | doğru | — | — | 1.00 |
| tur_11 | Kırmızı | Kırmızı | evet | C | Kapiller kan şekeri, EKG, Kan gazı | Tam kan sayımı, Bilirritaryon testi, Renal fonksiyon testleri | 0.00 |
...
| tur_13 | Kırmızı | Kırmızı | evet | C | Klinik değerlendirme ve fizik muayene | Tam kan sayımı, Plasma lactaz keton seviyesi, Allergenik reaksiyon testleri | 0.00 |
...
| tur_15 | Kırmızı | Kırmızı | evet | C | Tam kan sayımı, Kan grubu, Cross-match, Koagülasyon paneli | Tam kan sayımı, Nabız ve kan basıncı ölçümü, Gastrointestinal endoskopi | 0.17 |
...
| tur_19 | Sarı | Sarı | evet | C | Parmak ucu kan şekeri, Tam kan sayımı, Rutin biyokimya | Psikiyatrik değerlendirme, Depresyon ölçeği uygulaması | 0.00 |
